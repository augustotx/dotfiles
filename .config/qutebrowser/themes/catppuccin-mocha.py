...
bg_default = "#1e1e2e"          # main shade darkest
bg_lighter = "#313244"
bg_selection = "#585b70"
# "#545862"
fg_disabled = "#a6adc8"
fg_default = "#cdd6f4"
# "#b6bdca"
bg_lightest = "#7f849c"         # main shade lightest
fg_error = "#f38ba8"            # red
# "#d19a66"                     # orange
bg_hint = "#f9e2af"             # yellow
fg_matched_text = "#a6e3a1"     # green
bg_passthrough_mode = "#94e2d5" # teal
bg_insert_mode = "#89b4fa"      # blue
bg_warning = "#cba6f7"          # purple
# "#be5046"                     # dark red
